...
def synchronize_scene(
    ...
    out_path = PATHS["timelines"] / f"scene_{scene_id}.json"
...
def synchronize_all(
    ...
    timelines = [synchronize_scene(plan, audio_paths[plan["scene_id"]]) for plan in plans]

    master_path = PATHS["timelines"] / "master_timeline.json"
