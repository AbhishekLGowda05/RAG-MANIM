...
class TorqueTemplate:
    ...
    def compile(plan: dict[str, Any], timeline: dict[str, Any]) -> str:
        ...
        lines += [
            ...
            f'        torque_arc_tip = ArrowTip(color="{TORQUE_ARC_COLOR}")',
            f'        torque_arc_tip.scale(0.55)',
            f'        torque_arc_tip.move_to(torque_arc.get_end())',
            f'        torque_arc_tip.rotate(-PI/2 + PI/3)',
            ...
            f'        arc_grp = VGroup(torque_arc, torque_arc_tip, tau_lbl)',
